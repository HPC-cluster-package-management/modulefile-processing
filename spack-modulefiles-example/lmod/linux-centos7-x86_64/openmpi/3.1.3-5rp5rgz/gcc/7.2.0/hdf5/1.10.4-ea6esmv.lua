-- -*- lua -*-
-- Module file created by spack (https://github.com/spack/spack) on 2019-09-16 13:50:15.030665
--
-- hdf5@1.10.4%gcc@7.2.0~cxx~debug~fortran~hl+mpi+pic+shared~szip~threadsafe arch=linux-centos7-x86_64 /ea6esmv
--
...
prepend_path("PATH", "/u/local/spack/0.12/opt/spack/linux-centos7-x86_64/gcc-7.2.0/hdf5-1.10.4-ea6esmvnwc6ogndcbitrjvmsnqfijmm5/bin", ":")
prepend_path("LD_LIBRARY_PATH", "/u/local/spack/0.12/opt/spack/linux-centos7-x86_64/gcc-7.2.0/hdf5-1.10.4-ea6esmvnwc6ogndcbitrjvmsnqfijmm5/lib", ":")
prepend_path("CMAKE_PREFIX_PATH", "/u/local/spack/0.12/opt/spack/linux-centos7-x86_64/gcc-7.2.0/hdf5-1.10.4-ea6esmvnwc6ogndcbitrjvmsnqfijmm5/", ":")
setenv("HDF5_ROOT", "/u/local/spack/0.12/opt/spack/linux-centos7-x86_64/gcc-7.2.0/hdf5-1.10.4-ea6esmvnwc6ogndcbitrjvmsnqfijmm5")
