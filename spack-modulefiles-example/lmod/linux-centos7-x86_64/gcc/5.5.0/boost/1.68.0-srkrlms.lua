-- -*- lua -*-
-- Module file created by spack (https://github.com/spack/spack) on 2019-09-16 13:41:54.957614
--
...
prepend_path("LD_LIBRARY_PATH", "/u/local/spack/0.12/opt/spack/linux-centos7-x86_64/gcc-5.5.0/boost-1.68.0-srkrlms47eozzfkwj6h2ksavxyajogmb/lib", ":")
prepend_path("CMAKE_PREFIX_PATH", "/u/local/spack/0.12/opt/spack/linux-centos7-x86_64/gcc-5.5.0/boost-1.68.0-srkrlms47eozzfkwj6h2ksavxyajogmb/", ":")
setenv("BOOST_ROOT", "/u/local/spack/0.12/opt/spack/linux-centos7-x86_64/gcc-5.5.0/boost-1.68.0-srkrlms47eozzfkwj6h2ksavxyajogmb")
