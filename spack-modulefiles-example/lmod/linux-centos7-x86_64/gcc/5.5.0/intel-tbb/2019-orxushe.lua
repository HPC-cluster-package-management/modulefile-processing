-- -*- lua -*-
-- Module file created by spack (https://github.com/spack/spack) on 2019-09-16 13:52:27.697890
--
...
prepend_path("LD_LIBRARY_PATH", "/u/local/spack/0.12/opt/spack/linux-centos7-x86_64/gcc-5.5.0/intel-tbb-2019-orxusheuwz6ocirrmw3jcucnb2rk72oi/lib", ":")
prepend_path("CMAKE_PREFIX_PATH", "/u/local/spack/0.12/opt/spack/linux-centos7-x86_64/gcc-5.5.0/intel-tbb-2019-orxusheuwz6ocirrmw3jcucnb2rk72oi/", ":")
setenv("INTEL_TBB_ROOT", "/u/local/spack/0.12/opt/spack/linux-centos7-x86_64/gcc-5.5.0/intel-tbb-2019-orxusheuwz6ocirrmw3jcucnb2rk72oi")
